    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .date-btn { aspect-ratio:1; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:1px; border:1px solid #1e1e1e; border-radius:8px; background:#111; cursor:pointer; transition:all 0.15s; padding:6px; }
